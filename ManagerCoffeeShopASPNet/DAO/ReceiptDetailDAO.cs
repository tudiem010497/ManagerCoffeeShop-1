...
namespace ManagerCoffeeShopASPNet.DAO
{
    interface ReceiptDetailDAO
    {
        ...
        bool InsertReceiptDetailMissIngreID(int ReceiptID, int GiftID, double Amount, double UnitPrice, string Currency, string Status);
        bool InsertReceiptDetailMissGiftID(int ReceiptID, int IngreID, double Amount, string Unit, double UnitPrice, string Currency, string Status);
